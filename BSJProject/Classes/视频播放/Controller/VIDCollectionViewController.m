...
//@interface VIDCollectionViewController ()<SUPVerticalFlowLayoutDelegate, ZFPlayerDelegate>
///**网络数据*/
...
//    [self showLoading];
//    [[SUPRequestManager sharedManager] GET:[SUPSUPBaseUrl stringByAppendingPathComponent:@"video"] parameters:parameters completion:^(SUPBaseResponse *response) {
...
//    SUPXGMVideo *video = self.videos[indexPath.row];
//    
...
//        // _playerView.stopPlayWhileCellNotVisable = YES;
//        
////        _playerView.forcePortrait = NO; //被禁用
//        
...
//    return [SUPVerticalFlowLayout flowLayoutWithDelegate:self];
//}
//
