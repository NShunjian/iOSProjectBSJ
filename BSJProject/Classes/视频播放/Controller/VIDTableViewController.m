...
//    [self showLoading];
//    [[SUPRequestManager sharedManager] GET:[@"http://120.25.226.186:32812" stringByAppendingPathComponent:@"video"] parameters:parameters completion:^(SUPBaseResponse *response) {
...
//        // _playerView.stopPlayWhileCellNotVisable = YES;
//        
////        _playerView.forcePortrait = NO;//被框架弃用
//        
