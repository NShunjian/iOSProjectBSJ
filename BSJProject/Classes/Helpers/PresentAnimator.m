...
void *id_key = &id_key;
@implementation UIViewController (SUPAdd)
...
- (UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(UIViewController *)presenting sourceViewController:(UIViewController *)source {
    ...
    SUPPresentationController *presVc = [[SUPPresentationController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
...
- (void)presentAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (_presentAnimation) {
        SUPWeakSelf(presentedView);
        SUPWeakSelf(transitionContext);
        SUPWeakSelf(containerView);
...
@implementation SUPPresentationController
