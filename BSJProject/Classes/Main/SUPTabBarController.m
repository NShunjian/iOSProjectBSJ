...
- (NSArray *)viewControllers {
    UIViewController *one = [[SUPNavigationController alloc] initWithRootViewController:[[SUPEssenceViewController alloc] init]];

    UIViewController *two = [[SUPNavigationController alloc] initWithRootViewController:[[SUPNewViewController alloc] init]];

    UIViewController *three = [[SUPNavigationController alloc] initWithRootViewController:[[SUPFriendTrendsViewController alloc] init]];
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    //FIXED: #196
    UIImage *tabBarBackgroundImage = [UIImage imageNamed:@"tabbar-light"];
